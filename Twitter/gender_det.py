...
import numpy as np
class Gender_det:
# Este codigo es para la deteccion de rostro y apartir de ahi el genero

    def __init__(self, weights) -> None:
        '''
        params:
        weigths: String, con la ruta a la carpeta con  los weitgths
        '''
        self._weights = weights

        #Codigo obtenido de :
        #https://github.com/x4nth055/pythoncode-tutorials/blob/master/machine-learning/face-gender-detection/predict_gender.py

        # The gender model architecture
        # https://drive.google.com/open?id=1W_moLzMlGiELyPxWiYQJ9KFaXroQ_NFQ
        #GENDER_MODEL = r'C:\Users\monch\Documents\sevicio\Deteccion_de_Genero\Twitter\weights\deploy_gender.prototxt'
        GENDER_MODEL = self._weights+'\\deploy_gender.prototxt'
        # The gender model pre-trained weights
        # https://drive.google.com/open?id=1AW3WduLk1haTVAxHOkVS_BEzel1WXQHP
        GENDER_PROTO = self._weights+'\\gender_net.caffemodel'
        ...
        FACE_PROTO =  self._weights+'\\deploy.prototxt.txt'
        # https://raw.githubusercontent.com/opencv/opencv_3rdparty/dnn_samples_face_detector_20180205_fp16/res10_300x300_ssd_iter_140000_fp16.caffemodel
        FACE_MODEL = self._weights+'\\res10_300x300_ssd_iter_140000_fp16.caffemodel'

        #import os
        #print(os.path.exists(r"C:\Users\monch\Documents\sevicio\Deteccion_de_Genero\Twitter\weights\deploy_gender.prototxt"))
    ...
    def predict_gender(self, input_path: str):
        ...
        # img = cv2.resize(img, (self.frame_width, frame_height))
